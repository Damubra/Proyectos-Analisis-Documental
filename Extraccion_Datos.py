...
documento = input(str("Introduce la ruta de la imagen: ")) #INGRESAR LA RUTA DE LA IMAGEN (TIP: IMAGEN > DETALLES)
imagen_0 = Image.open(documento) #DEFINIMOS LA VARIABLE IMAGEN

ancho, alto = imagen_0.size #DEFINIMOS EL TAMAÑO DE LA IMAGEN
imagen = imagen_0.crop((0, 0, ancho*0.70, alto))  #RECORTAMOS HORIZONTALMENTE LA IMAGEN A LA MITAD
